...
\bibliography{carl_abbrev,carl_main,carl_calif,carl_alaska,carl_source}
%-------------------------------------------------------------
...
\item Explain the pattern in \refFig{fig}c and how it occurs. Comment out the first \verb+break+ statement to annotate the plot in (a) to help your understanding.
...
\caption[]
{{
Figure generated by {\tt lab$\_$sampling.m} (\refApp{sec:code}).
