...
Assigned: March 22, 2017 --- Due: April 3, 2017 \\
Last compiled: \today
\end{spacing}
...
the $\ndata \times \nparm$ design matrix $\bG$ is a discrete representation of the integral operator in \refEq{Kxy}. The vector $\bem$ of density variations plays the role of the regression coefficients. The vector $\bd$ of gravity variations is the response variable.
